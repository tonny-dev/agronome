<form method="POST" action="{{ route('register') }}" style="margin-top: 10%; padding-left:10%">
    @csrf
    ...
    <div style="margin-left:28%;font-size:18px; font-weight:medium;color:#0A4022;font-family:'Open Sans';">Create an Account</div>
        ...
        <div class=" row w-100 pt-3">
            <div class="col-md-12">
                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror mtextbox  "
