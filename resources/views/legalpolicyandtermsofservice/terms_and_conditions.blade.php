        ...
        <div class="flex h-full">
            ...
            <main class="w-full bg-white mx-4">
                <div class="mt-8 border-b border-green-600">
                    <h1 class="font-bold pb-2">Terms Of Service</h1>
                </div>

                <div class="mt-4">
                    <h1 class="pb-8 font-bold">Welcome to <span><a class="text-green-600 font-medium" href="http://aires.co.ke">aires</a></span></h1>
                ...
                <div class="mt-4">
                    <h1 class="pb-8 font-bold">Using our Services</h1>
