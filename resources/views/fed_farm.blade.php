...
<head>
    ...
    <link href="{{ asset('css_farm/styles.css') }}" rel="stylesheet"> 
...
<body>
    ...
    <div class="container max-auto">
        <table class="w-full h-screen table-fixed">
            ...
            <tr valign="top">
                ...
                <!--Content Center-->
                <td class="bg-white" id="topButtons">
                    <div class="grid grid-cols-3 gap-4 pt-4">
                        <div class="pl-6">
                            <button class="btn active p-2 tex-white shadow-lg outline-none"><a href="farm_location.html">Add Farm</a><span class="pl-4 float-right"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M10.7 9.4H20v1.3h-9.4V20H9.4v-9.4H0V9.4h9.4V0h1.3v9.4z" fill="#fff"/></svg></span></button>
                        </div>

                        <div>
                            <button class="btn border p-2 text-green-500 outline-none">Add Fields <span class="pl-4 float-right"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M10.7 9.4H20v1.3h-9.4V20H9.4v-9.4H0V9.4h9.4V0h1.3v9.4z" fill="#168d4b"/></svg></span></button>
                        </div>
                        <div>
                            <button class="btn border border-green-500 p-2 text-green-500 outline-none">Add Crop<span class="pl-4 float-right"><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M10.7 9.4H20v1.3h-9.4V20H9.4v-9.4H0V9.4h9.4V0h1.3v9.4z" fill="#168d4b"/></svg></span></button>
                        </div>

                    </div>
                    <div class="pt-24">
                        <div class="flex justify-center">
                            <img src="images_farm/farm/u234.svg">
                        </div>
                        <h2 class="text-center text-2xl font-bold underline text-green-700">Welcome</h2>
                        <h3 class="text-center text-l font-bold text-green-500 pt-4">To get started, click on <span class="underline">Add Farm</span></h3>
                    </div>
                </td>
                <!--Right Side-->
                <td class="bg-gray-100 w-1/5">
                    <div class="pt-6 pl-4">
                        <h3 class="text-green-500 font-bold">Continue to <span class="underline"><a href="profile.html">My profile</a></span> to complete registration</h3>
                    </div>
                </td>
